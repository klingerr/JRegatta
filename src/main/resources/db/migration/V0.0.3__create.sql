    ...
    alter table Race 
        drop constraint FK26BEF1E2D31A97;

    alter table Result 
        drop constraint FK91B2B43D235B8BDD;

    alter table Result 
        drop constraint FK91B2B43D719E2E57;

    alter table Skipper 
        drop constraint FKE337FF1E1D9905BD;

    alter table Skipper 
        drop constraint FKE337FF1EE2D31A97;
